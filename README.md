...
This study uses a 2x2 within-subjects design to test how familiarity and duration affect working memory in free recall. Using Repeated Measures ANOVA (F, p, ηp²) in JAMOVI, results showed a significant effect for familiarity (p&lt;.001, ηp² =.756), but no impact for stimulus duration or their interaction.
